export class Servico {
    constructor(
        ...
        if (preco == undefined || preco == null) throw new Error("preço obrigatório");
        if (tempoEstimado == undefined || tempoEstimado == null) throw new Error("tempo estimado obrigatório");

        if (nome.length < 3) throw new Error("nome muito curto");
        if (preco < 0) throw new Error("preco deve ser maior que 0");
        if (tempoEstimado < 0) throw new Error("tempo estimado deve ser maior que 0");
    }
